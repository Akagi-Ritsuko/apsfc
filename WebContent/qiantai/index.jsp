	...
	<table width="900" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top"><table width="100%" border="0"
					...
					String strPage=(String)request.getParameter("currentPage");
					...
					list = md.pageList(currentPage,maxrow*3);
					menulist=md.select(); %>
					<tr>
																...
																<%
																	if ((currentrow + 1) == rowcount && rscount % maxrow != 0) {
																			...
																			for (currentrs = currentrow * maxrow; currentrs < currentrow
																				...
																				Menus menus = list.get(currentrs);
																%>
																		...
																		<table >
																			<tr>
																				<td rowspan="5" class="bookPic"><img 
																					...
																					style="border: 1px solid #300;height: 140px;width: 160px;" /></td>
																				<td><span>菜名:</span></td>
																			...
																			<tr>
																				<td><span>配料:</span></td>
																				<td><span title="<%=menus.getBurden()%>" style="display:inline-block; border:0px solid white;width:85px;height:14px;text-overflow: ellipsis;white-space: nowrap;overflow: hidden; "><%=menus.getBurden()%></span></td>
																			</tr>
																			<tr>
